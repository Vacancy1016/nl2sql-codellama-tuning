...
CUDA_VISIBLE_DEVICES=0,1  python dbgpt_hub_sql/predict/predict.py \
    --model_name_or_path /root/autodl-tmp/CodeLlama-13b/AI-ModelScope/CodeLlama-13b-Instruct-hf \
    --template llama2 \
    --finetuning_type lora \
    --predicted_input_filename dbgpt_hub_sql/data/example_text2sql_dev.json \
    --checkpoint_dir dbgpt_hub_sql/output/adapter/CodeLlama-13b-sql-lora/checkpoint-4336 \
